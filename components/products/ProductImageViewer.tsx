...
const ProductImageViewer = ({
  ...
  return (
    <div
      className="fixed inset-0 z-[120] flex flex-col bg-gray-950/96 text-white backdrop-blur-sm"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div className="flex items-center justify-between gap-4 border-b border-white/10 px-4 py-3 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={onClose}
            className="grid h-11 w-11 place-items-center rounded-full border border-white/15 bg-white/10 transition hover:bg-white hover:text-gray-950"
      ...
      {hasMultipleImages && (
        <div className="border-t border-white/10 bg-gray-950/80 px-4 py-3">

    ...
    const bodyHtml = `
      ...
      <div class="page">
        <div class="deck">
          ...
          <section class="slide"><div class="slide-content"><div class="eyebrow">Slide 4</div><h2>Product (Demo)</h2><ul class="list"><li>Web platform</li><li>Admin dashboard</li><li>Seller dashboard</li><li>Buyer dashboard</li><li>Rider dashboard</li></ul><p class="lead" style="margin-top:28px;">The system is already built, functional, and structured for deployment readiness.</p></div></section>
          ...
          <section class="slide"><div class="slide-content"><div class="eyebrow">Slide 7</div><h2>Traction (Current Status)</h2><ul class="list"><li>Platform developed and working.</li><li>Multiple dashboards implemented.</li><li>Ready for deployment.</li></ul><div class="mini-grid"><div class="stat-box"><div class="k">Verified Merchants</div><div class="v">${html.escape(String(metrics.verifiedMerchants))}</div></div><div class="stat-box"><div class="k">Successful Orders</div><div class="v">${html.escape(String(metrics.successfulOrders))}</div></div><div class="stat-box"><div class="k">Order Growth</div><div class="v">${html.escape(`${metrics.orderGrowth}%`)}</div></div><div class="stat-box"><div class="k">Gross Revenue</div><div class="v">RWF ${html.escape(metrics.grossRevenue.toLocaleString())}</div></div></div></div></section>
